...
int Scene::Render(GLFWwindow* pWwindow)
{
    return -1;
}
...
void Scene::KeyboardInput(GLFWwindow* pWwindow)
{
    return;
}

void Scene::MouseInput(GLFWwindow* pWwindow, double xPos, double yPos)
{
    return;
}

// Display : Per-frame execution of the scene
int Scene::Display(GLFWwindow* pWwindow)
{
    preRender();
